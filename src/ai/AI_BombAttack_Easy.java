...
public class AI_BombAttack_Easy extends AI_BombAttack{

	public AI_BombAttack_Easy() {
	...
	public AI_Move onDoBombAttack(Player current_challenger, CardSlot card_slot) {
		...
		//Card card = card_slot.getSelectedCard();
		//if(card.getPowerUp() == BombPowerUp.SinglePoint); //check the type of power up card
