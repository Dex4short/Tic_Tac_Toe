...
public abstract class MenuSelection extends Rectangle implements Drawable, AWTEventListener{
	...
	private class ButtonGrid extends SwappableButton{
		...
		public ButtonGrid() {
			super("Grid", new String[] {"3x3", "4x4", "5x5" });
		}
		@Override
		public void onAction() {
			super.onAction();
			...
			else if(getSelected().equals("4x4")) {
				game_play.setGrid_type(GridType.Grid_4x4);
			}
			else if(getSelected().equals("5x5")) {
				game_play.setGrid_type(GridType.Grid_5x5);
			}
		}
	}
